...
public class SimStat2CardsWinLoseV3
{
	/*------------------------------------------------------------------*\
	|*							Attributs Private						*|
	\*------------------------------------------------------------------*/
	...
	private static final int					NB_SIMULATION		= 100000 / NB_CORE;
	...
	public static void main() throws IOException, InterruptedException, ExecutionException
	{
		...
		for(int i = 0; i < hands.length; ++i)
		{
			...
			{
				callables.add(callable(hands[i]));
			}
		}
	...
	private static Callable<Void> callable(final Record hand)
	{
		return new Callable<Void>()
		{
			...
			{
				simulation(hand.getC1(), hand.getC2(), hand.getSame());
				return null;
			}
		};
	}
